...
export default function TableGradient (props) {
	return (
		<View pointerEvents="none" style={[ StyleSheet.absoluteFill, _s.contaiter ]}>
			<Svg pointerEvents="none" width={'100%'} height={'100%'} {...props}>
				<Defs>
					<LinearGradient id="prefix__a" x1="0%" y1="0%" x2="0%" y2="100%">
						<Stop offset="0%" stopColor="rgb(255,255,255)" stopOpacity={'1'} />
						{/* <Stop offset="5%" stopColor="rgb(255,0,0)" stopOpacity={'0.75'} />
						<Stop offset="10%" stopColor="rgb(255,0,0)" stopOpacity={'0.5'} />
						<Stop offset="15%" stopColor="rgb(255,0,0)" stopOpacity={'0.25'} /> */}
